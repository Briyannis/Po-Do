...
router.post("/tokens", async (req, res) => {
  ...
  let redirect_uri = process.env.REDIRECT_URI || "http://localhost:3001/spotify-api/callback";

  var generateRandomString = function (length) {
    var text = '';
    var possible = '&$Si%t{v!Y=Lz{YeW5#kLtuJG22)BKm*@@T2P+6mdyRvL+HT#+5hqB@KnuBn';
